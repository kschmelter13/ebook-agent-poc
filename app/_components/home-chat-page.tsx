        ...
        <div className="flex min-h-0 flex-1 items-center justify-center pb-20 sm:pb-[12vh]">
          <div className="w-full max-w-2xl space-y-5 sm:space-y-7 md:space-y-8">
            <div className="space-y-3 text-center">
              <div className="mx-auto flex size-16 items-center justify-center rounded-2xl bg-foreground text-background shadow-sm sm:size-20">
                <BookOpenTextIcon className="size-8 sm:size-10" />
              </div>
              <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Booksmith</h1>
              <p className="mx-auto max-w-lg text-sm leading-6 text-muted-foreground sm:text-base">
                Turn one focused idea into a designed 10–50 page guide, complete with cover,
                contents, and a downloadable PDF.
              </p>
            </div>
            <ChatComposer
              autoFocus
              ...
              placeholder="What should we turn into an ebook?"
              value={draft}
            />
          </div>
        </div>
